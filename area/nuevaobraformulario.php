...
<div class="w3-main" style="margin-left:370px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:80px" id="añadiralumno">
    ...
    <form action="nuevaobra.php" method="post" enctype="multipart/form-data"><strong>
...
<input class="w3-input w3-border" required type=text name=direccion  >
  ...
  <div class="w3-section">
Jefe:
<select name="jefe" class="w3-input w3-border">
<?php
...
?>
 ...
 <div class="w3-section">
Latitud:
<input class="w3-input w3-border" required type=text name=latitud   >
</div>
  <div class="w3-section">
    Longitud:
<input class="w3-input w3-border" required type=text name=longitud >
</div>
  <div class="w3-section">
Cliente:

<select name="cliente" class="w3-input w3-border">
<?php
