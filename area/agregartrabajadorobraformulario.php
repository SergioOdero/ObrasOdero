...
<div class="w3-main" style="margin-left:370px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:80px" id="añadiralumno">
    <h1 class="w3-xxxlarge w3-texto"><b>Asignar obrero a la obra</b></h1>
    <hr style="width:50px;border:5px solid #25333C" class="w3-round">
    
 
    <form action="agregartrabajadorobra.php" method="post" enctype="multipart/form-data"><strong>
...
<select name="empleado" class="w3-input w3-border" >">
<?php
