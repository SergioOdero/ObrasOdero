...
<nav class="w3-sidebar w3-color  w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <div class="w3-container">
    <h3 class="w3-padding-10"><?php echo $nickadmin; ?></h3>
  </div>
...
<div class="w3-main" style="margin-left:370px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:80px" id="añadiralumno">
    <h1 class="w3-xxxlarge w3-texto"><b>Gestionar obras</b></h1>
    <hr style="width:50px;border:5px solid #25333C" class="w3-round">
    <br>
     <button type="button" class="block" onclick=window.location.href="agregartrabajadorobraformulario.php">Agrega trabajador a la obra</button>
     <br> 
   <?php
      $conexion=mysqli_connect("localhost","id11683743_sergio","trebujena","id11683743_obras") or
      die("Problemas con la conexión");
...
$empezar_desde = ($pagina-1) * $cantidad_resultados_por_pagina;
      $query=mysqli_query($conexion,"SELECT obras.Obra_id,obras.Obra_nombre,obras.Obra_direccion,obras.Obra_latitud,obras.Obra_longitud,Obra_longitud,usuarios.Usuario_nick as Obra_jefe,usuarios.Usuario_nick as Obra_cliente  from obras,usuarios where  usuarios.Usuario_id=obras.Obra_jefe");
    $result= mysqli_num_rows($query);
$total_paginas = ceil($result / $cantidad_resultados_por_pagina); 
   $query=mysqli_query($conexion,"SELECT obras.Obra_id,obras.Obra_nombre,obras.Obra_direccion,obras.Obra_latitud,obras.Obra_longitud,Obra_longitud,usuarios.Usuario_nick as Obra_jefe,usuarios.Usuario_nick as Obra_cliente  from obras,usuarios where  usuarios.Usuario_id=obras.Obra_jefe LIMIT $empezar_desde, $cantidad_resultados_por_pagina ");
    $query2=mysqli_query($conexion,"SELECT usuarios.Usuario_nick as Obra_cliente from usuarios,obras where  usuarios.Usuario_id=obras.Obra_cliente");
...
echo "</td>";
 echo "<td>";
echo $fila["Obra_direccion"];
echo "</td>";
 echo "<td>";
echo $fila["Obra_jefe"];
echo "</td>";
 echo "<td>";
echo $fila["Obra_latitud"];
 echo "</td>";
  echo "<td>";
 echo $fila["Obra_longitud"];
      echo "</td>";
       echo "<td>";
       
echo $fila2["Obra_cliente"];
echo "</td>";
...
/* echo "<input type=button value='Eliminar'  onclick=window.location.href='https://sergio-odero.000webhostapp.com/eliminarusuario.php?nick="; echo $nick; echo "';>";*/
 //echo "<img class='imagenesadministracion' src=imagenes/eliminarproveedor.png title='Eliminar proveedor' onclick=window.location.href='https://obrasodero.000webhostapp.com/area/eliminarobra.php?nick="; echo $id; echo "';> ";
 //echo "</td>";
  echo "<td>";
  echo "<img class='imagenesadministracion' src=imagenes/editarproveedor.png title='Editar usuario' onclick=window.location.href='https://obrasodero.000webhostapp.com/area/editarobraformulario.php?nick="; echo $id; echo "';> ";
   echo "</td>";
...
for ($i=1; $i<=$total_paginas; $i++) {
 ...
 <br><br>
 <button type="button" class="block" onclick=window.location.href="nuevaobraformulario.php">Agrega obra</button>
