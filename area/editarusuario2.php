...
move_uploaded_file($_FILES["foto"]["tmp_name"], $target_file);
    ...
    if($result>0) {
if (strcmp($foto, ";") > 0) {
     mysqli_query($conexion, "update usuarios set  Usuario_apellido1='$apellido1',Usuario_apellido2='$apellido2',Usuario_domicilio='$domicilio',Usuario_nombre='$nombre',Usuario_nif='$nif',Usuario_fotografia='$target_file'  WHERE Usuario_nick= '$nick' ");

  } else {
      

     mysqli_query($conexion, "update usuarios set  Usuario_apellido1='$apellido1',Usuario_apellido2='$apellido2',Usuario_domicilio='$domicilio',Usuario_nombre='$nombre',Usuario_nif='$nif' WHERE Usuario_nick= '$nick'");
  }
