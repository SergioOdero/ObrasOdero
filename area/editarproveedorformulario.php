...
$cif=$fila["Proveedor_CIF"];
$contacto=$fila["Proveedor_Persona_Contacto"];
...
<div class="w3-main" style="margin-left:370px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:80px" id="añadiralumno">
    ...
    <form action="editarproveedor.php?nick=<?php echo $nick;?>" method="post" enctype="multipart/form-data"><strong>
...
<input class="w3-input w3-border" required type=text name=direccion  value="<?php echo $direccion; ?>"  >
  ...
  <div class="w3-section">
CIF:
<input class="w3-input w3-border" required type=text name=cif value="<?php echo $cif; ?>"  >
</div>
 <div class="w3-section">
Persona de contacto:
<input class="w3-input w3-border" required type=text name=contacto  value="<?php echo $contacto; ?>" >
</div>
  <div class="w3-section">
    Telefono:
<input class="w3-input w3-border" required type=text name=telefono value="<?php echo $telefono; ?>">
</div>
  <div class="w3-section">
Email:
<input class="w3-input w3-border" required type=text name=email value="<?php echo $email; ?>"  >
</div>
