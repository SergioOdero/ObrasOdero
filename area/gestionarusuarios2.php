	...
	if (is_string($_GET["pagina"])) {
		...
		//Si la string es numérica, define la variable 'pagina'
		 if (is_numeric($_GET["pagina"])) {
			 ...
			 if ($_GET["pagina"] == 1) {
				 header("Location: gestionarusuarios2.php");
				 die();
...
$total_paginas = ceil($result / $cantidad_resultados_por_pagina); 
  ...
  echo $fila;
    while ($fila=mysqli_fetch_array($query)) {
        ...
        echo "<tr>";
        echo "<td>";
        echo "<input type=checkbox name=nick value=";echo $nick; echo ">"; echo $nick ;
echo "</td>";
 echo "<td>";
echo $fila["Usuario_nombre"];
echo "</td>";
...
/* echo "<input type=button value='Eliminar'  onclick=window.location.href='https://sergio-odero.000webhostapp.com/eliminarusuario.php?nick="; echo $nick; echo "';>";*/
 echo "<img class='imagenesadministracion' src=imagenes/eliminarusuario.png title='Eliminar usuario' onclick=window.location.href='https://sergio-odero.000webhostapp.com/eliminarusuario.php?nick="; echo $nick; echo "';> ";
  echo "<img class='imagenesadministracion' src=imagenes/editarusuario.png title='Editar usuario' onclick=window.location.href='https://sergio-odero.000webhostapp.com/editarusuario.php?nick="; echo $nick; echo "';> ";
   if($tipo=="administrador") {
        echo "<img class='imagenesadministracion' src=imagenes/quitaradmin.png onclick=window.location.href='https://sergio-odero.000webhostapp.com/quitaradmin.php?nick="; echo $nick; echo "'; title='Quitarle los permisos de  admin'> ";
   } else {
        echo "<img class='imagenesadministracion'src=imagenes/poneradmin.png title='Convertirlo en admin' onclick=window.location.href='https://sergio-odero.000webhostapp.com/nuevoadmin.php?nick="; echo $nick; echo "';>  ";
