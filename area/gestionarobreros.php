...
<div class="w3-main" style="margin-left:370px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:80px" id="añadiralumno">
    <h1 class="w3-xxxlarge w3-texto"><b>Gestionar obreros</b></h1>
...
$empezar_desde = ($pagina-1) * $cantidad_resultados_por_pagina;
      $query=mysqli_query($conexion,"SELECT obras.Obra_id as obra_id,trabajadores_obra.usuario_id as usuario_id,obras.Obra_nombre as obra,usuarios.Usuario_nick as usuario,trabajadores_obra.fecha_inicio as fecha_inicio from trabajadores_obra,usuarios,obras  WHERE trabajadores_obra.usuario_id=usuarios.Usuario_id and obras.Obra_id=trabajadores_obra.obra_id");
    $result= mysqli_num_rows($query);
$total_paginas = ceil($result / $cantidad_resultados_por_pagina); 
   $query=mysqli_query($conexion,"SELECT obras.Obra_id as obra_id,trabajadores_obra.usuario_id as usuario_id,obras.Obra_nombre as obra,usuarios.Usuario_nick as usuario,trabajadores_obra.fecha_inicio as fecha_inicio from trabajadores_obra,usuarios,obras  WHERE trabajadores_obra.usuario_id=usuarios.Usuario_id and obras.Obra_id=trabajadores_obra.obra_id  LIMIT $empezar_desde, $cantidad_resultados_por_pagina ");
...
/* echo "<input type=button value='Eliminar'  onclick=window.location.href='https://sergio-odero.000webhostapp.com/eliminarusuario.php?nick="; echo $nick; echo "';>";*/
 echo "<img class='imagenesadministracion' src=imagenes/eliminarproveedor.png title='Eliminar obrero' onclick=window.location.href='https://obrasodero.000webhostapp.com/area/eliminarobrero.php?nick="; echo $idusuario; echo "';> ";
 echo "</td>";
  echo "<td>";
  echo "<img class='imagenesadministracion' src=imagenes/editarproveedor.png title='Editar usuario' onclick=window.location.href='https://obrasodero.000webhostapp.com/area/editarobreroformulario.php?nick="; echo $idusuario; echo "';> ";
   echo "</td>";
